...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "a3534567187d2edc428efd3f13466ff75fe5805c"
  WORKING_DIRECTORY "/workdir/build/thirdparty/msgsl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workdir/build/thirdparty/msgsl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workdir/build/thirdparty/msgsl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
