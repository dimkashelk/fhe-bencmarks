...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "51b7f2abdade71cd9bb0e7a373ef2610ec6f9daf"
  WORKING_DIRECTORY "/workdir/build/thirdparty/zlib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workdir/build/thirdparty/zlib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workdir/build/thirdparty/zlib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
