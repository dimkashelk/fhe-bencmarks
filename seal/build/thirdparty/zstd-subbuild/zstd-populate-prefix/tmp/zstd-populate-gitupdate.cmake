...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "f8745da6ff1ad1e7bab384bd1f9d742439278e99"
  WORKING_DIRECTORY "/workdir/build/thirdparty/zstd-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/workdir/build/thirdparty/zstd-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/workdir/build/thirdparty/zstd-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
